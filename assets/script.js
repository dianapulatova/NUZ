...
var queryInURL= "https://api.intellexer.com/intellexerApi/analyzeSentiments/?"  + APIKey;
...
$.ajax({
  ...
  var settings = {
    "async": true,
        "crossDomain": true,
        "url": "http://api.intellexer.com/analyzeSentiments?apikey=YourAPIKey&ontology=hotels&loadSentences=true",
        "method": "POST",
         "headers": {
   ...
   "cache-control": "no-cache"
     ...
     "processData": false,
     "data": "[{\"id\": \"snt1\", \"text\": \"YourText\"}, {\"id\": \"snt2\", \"text\": \"YourText\"}]"
   }
